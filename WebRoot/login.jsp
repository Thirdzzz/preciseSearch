...
<body>
<jsp:useBean id="user" class="newbean.UserInfo" scope="session"/>
	&quot;&quot;
	<!-- Header -->
	<header id="top">
	...
	<div id="page">
		...
		<div class="wrapper-login">
			...
			<section class="full">
				...
				<!--<form id="loginform" method="post" action="dashboard.jsp">!-->
				<form id="loginform" method="post" action="test2.jsp">
					<jsp:setProperty name="user" property="*"/>
					<p>
						<label class="required" for="username">Username:</label><br /> <input
							type="text" value="" class="full" name="username" />
					</p>

					<p>
						<label class="required" for="password">Password:</label><br /> <input
							type="password" value="" class="full" name="password" />
					</p>

					<p>
						<input type="checkbox" id="remember" class="" value="1"
							name="remember" /> <label class="choice" for="remember">Remember
							me?</label>
					</p>
					<%
						...
						//System.out.println("login.jsp-------"+request.getParameter("username"));
					...
					<p>
						...
						&nbsp; <a href="javascript: //;"
							...
							password?</a> or <a href="#">Need help?</a>
					</p>
					<div class="clear">&nbsp;</div>
